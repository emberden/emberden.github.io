    ...
    implements IChunkProvider
{
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        for(int i3 = 0; i3 < 1; i3++)
        {
            ...
            (new WorldGenMinable(Block.oreCoal.blockID, 64)).generate(worldObj, rand, j6, k9, j12);
        }
        ...
        for(int j3 = 0; j3 < 1; j3++)
        {
            ...
            (new WorldGenMinable(Block.oreIron.blockID, 64)).generate(worldObj, rand, k6, l9, k12);
        }
        ...
        for(int k3 = 0; k3 < 1; k3++)
        {
            ...
            (new WorldGenMinable(Block.oreGold.blockID, 32)).generate(worldObj, rand, l6, i10, l12);
        }
        ...
        for(int l3 = 0; l3 < 1; l3++)
        {
            ...
            (new WorldGenMinable(Block.oreRedstone.blockID, 56)).generate(worldObj, rand, i7, j10, i13);
        }
        ...
        for(int i4 = 0; i4 < 1; i4++)
        {
            ...
            (new WorldGenMinable(Block.oreDiamond.blockID, 28)).generate(worldObj, rand, j7, k10, j13);
        }
        ...
        for(int j4 = 0; j4 < 1; j4++)
        {
            ...
            (new WorldGenMinable(Block.oreLapis.blockID, 24)).generate(worldObj, rand, k7, l10, k13);
        }
